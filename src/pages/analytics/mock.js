...
function getRevenueData() {
  const data = [];
  const seriesCount = 3;
  const accessories = ['Male', 'Female', 'Other'];
...
function getMainChartData() {
  ...
  const d1 = generateRandomPicks(10000, 15000, 3, 90);
  const d2 = generateRandomPicks(100, 4000, 4, 90);
  const d3 = generateRandomPicks(3000, 7000, 3, 90);
